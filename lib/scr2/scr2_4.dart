...
class scr2_4 extends StatelessWidget {
              ...
              child: Column(
                children: [
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text('Travel Bot', style: TextStyle(color: Colors.white, fontSize: 20),),
                        ],
                      ),
                      ElevatedButton(
                  ...
                  Container(
                    ...
                    child: Text('歡迎來到旅行討論區，我是旅行機器人。\n...\n...', style: TextStyle(color: Colors.white, fontSize: 14),),
                  ),
                  Container(
                      height: 240,
                      width: 375,
                      color: Colors.yellow,
                      child: Center( child: Text('歡迎來到旅行討論區', style: TextStyle(color: Colors.white, fontSize: 26),),)
                  ),
                  Container(
                    height: 40,
