...
class scr2_5 extends StatelessWidget {
              ...
              child: Column(
                children: [
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text('Sport Bot', style: TextStyle(color: Colors.white, fontSize: 20),),
                        ],
                      ),
                      ElevatedButton(
                  ...
                  Container(
                    ...
                    child: Text('歡迎來到運動討論區，我是運動機器人。\n...\n...', style: TextStyle(color: Colors.white, fontSize: 14),),
                  ),
                  Container(
                      height: 240,
                      width: 375,
                      color: Colors.purpleAccent,
                      child: Center( child: Text('歡迎來到運動討論區', style: TextStyle(color: Colors.white, fontSize: 26),),)
                  ),
                  Container(
                    height: 40,
