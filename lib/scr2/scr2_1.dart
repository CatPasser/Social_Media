...
class scr2_1 extends StatelessWidget {
            ...
            child: Column(
              children: [
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text('Game Bot', style: TextStyle(color: Colors.white, fontSize: 20),),
                      ],
                    ),
                    ElevatedButton(
                ...
                Container(
                  ...
                  child: Text('歡迎來到遊戲討論區，我是遊戲機器人。\n...\n...', style: TextStyle(color: Colors.white, fontSize: 14),),
                ),
                Container(
                  height: 240,
                  width: 375,
                  color: Colors.green,
                  child: Center( child: Text('歡迎來到遊戲討論區', style: TextStyle(color: Colors.white, fontSize: 26),),)
                ),
                Container(
                  height: 40,
