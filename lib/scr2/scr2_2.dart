...
class scr2_2 extends StatelessWidget {
              ...
              child: Column(
                children: [
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text('Learning Bot', style: TextStyle(color: Colors.white, fontSize: 20),),
                        ],
                      ),
                      ElevatedButton(
                  ...
                  Container(
                    ...
                    child: Text('歡迎來到學習討論區，我是學習機器人。\n...\n...', style: TextStyle(color: Colors.white, fontSize: 14),),
                  ),
                  Container(
                      height: 240,
                      width: 375,
                      color: Colors.blue,
                      child: Center( child: Text('歡迎來到學習討論區', style: TextStyle(color: Colors.white, fontSize: 26),),)
                  ),
                  Container(
                    height: 40,
